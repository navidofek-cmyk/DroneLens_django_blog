...
urlpatterns = [
    ...
    path('posts/<slug:slug>/comments/',     api_views.CommentListCreateView.as_view(), name='api-comments'),
    path('posts/<slug:slug>/photos/',       api_views.PhotoUploadView.as_view(),    name='api-photos'),

    # Photos
    path('photos/<int:pk>/',               api_views.PhotoDeleteView.as_view(),    name='api-photo-delete'),
